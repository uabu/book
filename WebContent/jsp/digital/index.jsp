		...
		<div class="wrapper">
			...
			<div class="main container" style="margin-left: 0%">
				<div class="row">
					...
					<div class="col-md-10 main-right" style="margin-top:-52px;width: 66%;">
						<div class="pro col-md-12"  style="width: 100%">
							<h3 style="width:74% ">推荐商品</h3>
							<div id="recDigitals" class="pro-list">
								<ul>
						...
						<div class="pro col-md-12" style="width: 100%">
							<h3 >新品上市</h3>
							<div id="newDigitals" class="pro-list">
								<ul >
				...
				<div   class="col-md-2 main-left" style="margin-top: -52px;">
						<h3 style="border-bottom: 1px #ccc solid;">阅读推荐</h3>
