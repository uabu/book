...
<head>
	...
	<link href="css/digital/user_reg_login.css" rel="stylesheet" type="text/css">
...
<c:if test="${!empty infoList}">
	...
	<div>
		...
		<div class="wrapper" style="background:url(images/digital/loginbg.jpg);margin-top:-20px;background-repeat:no-repeat;background-size:cover;">
			<!-- main start -->
