...
<head>
    ...
    <script type="text/javascript" src="js/admin/digitalManage/digitalAdd.js"></script>
    <style type="text/css">
        body{
            margin:0;
            padding:0;
        ...
        .img-box{
        	width: 100px;
        	height:100px;
        	background:url("images/digital/noneImg.jpg") no-repeat center;
    ...
    <div class="row">
    	...
    	<div class="col-sm-4 ">
    		<div class="img-box" onclick="javascript:upImg()">
    			<img alt="" height="100px" src="${digitalInfo.upLoadImg.imgSrc}" >
    		</div>
    		<span id="imgSpan">点击图片更改图片</span>
    		<form id="imgForm" action="jsp/admin/DigitalManageServlet?action=updateImg&id=${digitalInfo.digitalId}" method="post" enctype="multipart/form-data">
     ...
     <div class="row">
		...
		<div class="col-sm-4 ">
		   ${digitalInfo.digitalName}
		</div>
            
    </div>
    <form id="digitalAddForm" class="form-horizontal" action="jsp/admin/DigitalManageServlet?action=update" method="post">
        <input type="hidden" name="digitalId" value="${digitalInfo.digitalId}">
                ...
                <select name="catalog" id="catalog" class="form-control">
                    ...
                    <c:if test="${!empty catalog}">
                        <c:forEach items="${catalog}" var="i">
                            <c:choose>
                                <c:when test="${i.catalogId eq digitalInfo.catalog.catalogId}">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-4">
                <input type="text" name="price" id="price" class="form-control" value="${digitalInfo.price}">
            </div>
            <div class="col-sm-4 Validform_checktip"></div>
        </div>
    	...
    	<div class="form-group">
            ...
            <div class="col-sm-4">
                <textarea rows="3" name="desc" id="desc" class="form-control" >${digitalInfo.description}</textarea>
            </div>
