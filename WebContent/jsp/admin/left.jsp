...
<body>
	<div class="nowTime" style="background:#333333;"></div>
	<div class="left">
		<ul>
			<li class="list">
				<h3>用 户 管 理</h3>
			...
			<li class="list">
				<h3>商品管理</h3>
				<ul>
					<li><a href="jsp/admin/DigitalManageServlet?action=list" target="rFrame">商品列表</a></li>
			...
			<li class="list">
				<h3>文 章 管 理</h3>
				<ul>
					<li><a href="MsgServlet?action=list" target="rFrame">文章列表</a></li>
					<li><a href="jsp/admin/BookServlet?action=list" target="rFrame">图书管理</a></li>
				</ul>
			</li>
		</ul>
	</div>
