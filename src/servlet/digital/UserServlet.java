...
public class UserServlet extends HttpServlet {
	...
	private static final String LOGIN_PATH="jsp/digital/reg.jsp?type=login";
	private static final String REG_PATH="jsp/digital/reg.jsp?type=reg";
	private static final String INDEX_PATH="jsp/digital/index.jsp";
	...
	private void offlogin(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
		User user =  (User) request.getSession().getAttribute(LANDING);
		if(user!=null) {
		...
		request.setAttribute("digitalList",digitals);
