...
public class CatalogServlet extends HttpServlet {
	...
	private static final String CATALOGLIST_PATH="digitalManage/catalogList.jsp";
	private static final String CATALOGADD_PATH="digitalManage/catalogAdd.jsp";
	...
	private void catalogBatDel(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(cd.catalogBatDelById(ids)) {
			request.setAttribute("digitalMessage", "分类已批量删除");
			
		}else {
			request.setAttribute("digitalMessage", "分类删除失败");
		}
		//用户删除成功失败都跳转到用户列表页面
