...
public class OrderItemDaoImpl implements OrderItemDao {
	...
	public boolean orderAdd(OrderItem orderItem) {
		String sql="insert into s_orderItem(digitalId,orderId,quantity) values(?,?,?)";
		
		int i= DbUtil.excuteUpdate(sql,orderItem.getDigitalId(),orderItem.getOrderId(),orderItem.getQuantity());
